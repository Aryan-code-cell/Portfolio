...
//             Aryan
//           </span>
//           <span className="staggered-reveal"> Singh
//           </span>
//         </h1>
//         <p>
//           <span
...
const Hero = () => {
  ...
  return (
    <section
      ref={sectionRef}
      id={MENULINKS[0].ref}
      className="w-full flex flex-row items-center py-8 2xl:container mx-auto xl:px-20 md:px-12 px-4 min-h-screen relative mb-24"
      style={{ opacity: 0 }}
    >
      <style global jsx>
        {`
      ...
      {/* Right Section */}
      <div className="w-1/2 flex flex-col pt-40 md:pt-0 select-none">
        <h5
          className={`${styles.intro} font-mono font-medium text-indigo-light staggered-reveal`}
        >
          Hi, my name is
